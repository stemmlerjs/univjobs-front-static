  ...
  render = () => {
    return (
      <div
        ...
        ${styles.container} ${this.state.shouldHideHeader ? styles.hideNav : ''}
        `}
        style={{
      ...
      >
        <div className="main-header-container-inner">
          ...
          <div className="nav-items">
            ...
            <Link className="nav-item" to="/companies">
              Explore Companies
            </Link>
            <div
            ...
            >
              SIGN UP
              <img className="before-hover" src={greenArrow} />
              <img className="after-hover" src={whiteArrow} />
            </div>
          </div>
          <div
          ...
          >
            <div>
              ...
              <div
                className={
                  this.state.menuOpen ? `${styles.change2} bar2` : 'bar2'
                }
              />

              <div
                className={
                  this.state.menuOpen ? `${styles.change3} bar3` : 'bar3'
                }
              />
            </div>
          </div>
          <HeaderOverlay isOpen={this.state.menuOpen} />
        </div>
      </div>
    )
  }
