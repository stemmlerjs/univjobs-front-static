  ...
  return (
    ...
    >
      ...
      <p>
        ...
        information through our Services or if you opt to utilize the
        aforementioned privacy features of your computer system or web browser,
        you may not be able to obtain certain content, features, services,
      ...
      <p>
        ...
        other publicly accessible search engines. Your personally-identifying
        information may also be disclosed to third parties in order to verify
        that information, including by contacting your educational institution
      ...
      <p>
        Links to Other Services. Our Services may also contain links to third
        party websites. Our Services may contain links to other Internet
        websites for the convenience of users in locating information, products,
        or services that may be of interest. If you access a third party website
        ...
        of these other websites, advertisers and any third parties.
      </p>
      ...
      <p>
        ...
        You acknowledge that the technical processing and transmission of our
      ...
      <p>
        ...
        meet the description hereunder. As set forth above, many computer
        systems and web browsers offer privacy settings and options that may
        allow you to opt-out of some of these data tracking and collection
        methods.
      </p>

      <p>
        If you wish to opt-out of receiving promotional emails at any time,
        please click the “unsubscribe” link at the bottom of the email.
      </p>

      <p>
        You may also opt-out from receiving further text messages by: texting
        STOP, UNSUBSCRIBE or CANCEL in response to our text message; by emailing
        your request to us at contact@univjobs.ca or by calling us at the phone
        number listed below.
      </p>

      <p>
        Please also be advised that your desire to opt-out of future
        communications will not be effective (nor will your Services
        registration or account be terminated) simply by deleting our App from
      ...
      <p>
        ...
        requests made in 2018 will receive information regarding 2017 sharing
        activities). If you are a California resident and would like a copy of
        this information, please submit a written request to:
      </p>
      ...
      <p>
        ...
        effective as to any visitor who has visited our Services before the
        change was made. It is the obligation of users visiting our Services
        before the change to learn of changes to the Privacy Policy since their
        last visit.
      </p>
