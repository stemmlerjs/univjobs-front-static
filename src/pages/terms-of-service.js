  ...
  <div style={{
    ...
    <div>
      ...
      <p>
        ...
        intend to be legally bound by them. If you do not agree to these Terms,
        or if you are under 18 years of age, or if you are not a legal resident
        of the Canada, you are not granted permission to use our Services and
        must exit immediately.
      </p>

      <ol>
        <li>
          <b>Registration.</b> In order to access certain content, services,
          products or benefits on our Services, you will be asked to register
          and create an account. By registering an account on our Services, you
          represent that you are 18 years of age or older. Depending on your
          intended uses of our Services, you may be asked to designate your
          account as either a Student Account (i.e., for a Student) or a
          Business Account (i.e., for a Business). Your obligations and rights
          ...
          <p>
            ...
            user name and password. Only you are permitted to access our
            Services, the Services Materials, and the User Content through your
            account. Without limiting the foregoing, you are fully responsible
          ...
          <p>
            By registering, you are subscribing to transactional notification
            emails and/or text messages related to the Services (including
            notifications that will inform you when a job that matches your
            profile is posted). You can unsubscribe or manage your notification
            frequency settings at any time by logging into your account and
            changing your notification settings or by using any of the other
            methods described in the Privacy Policy.
          </p>
        </li>
        ...
        <li>
          <p />
          <b>Listing Employment or Contracting Opportunities</b> Upon
          registration, a Business may submit, through our Services, a
          notification to Students of a potential employment or contracting
          opportunity (a “Job Posting”). A Job Posting may only notify Students
          of a single employment or contracting opportunity, and must include,
        ...
        <li>
          <p />
          <b>Privacy.</b> It is important that you read and understand the
          Privacy Policy, especially because the nature of the Services
        ...
        <li>
          <p />
          <b>Payment.</b> Some of our Services, including the opportunity for a
        ...
        <li>
          ...
          Services (“Services Materials”), as well as the selection,
          ...
          kind in or to the Services Materials, other than the right to use the
          Services Materials in accordance with these Terms.
          <p>
          ...
          <p>
            Certain features of the Services (including the registration
            processes described in Section 1 above) may allow you to contribute
            comments, feedback, information, content, text, files, trademarks,
            logos, graphics, postings, and other materials and information,
            including Job Postings, for access, use, viewing and commentary by
            other users to the Services (“User Content”). By posting User
            Content, you represent that you have the full legal right to provide
            the User Content and that use of the User Content by our Services
            and all other persons and entities will not: (a) infringe any
            intellectual property rights of any person or entity or any rights
            of publicity, personality, or privacy of any person or entity,
            including as a result of your failure to obtain consent to post
            personally identifying or otherwise private information about a
            person; (b) violate any law, statute, ordinance, regulation, or
            agreement; (c) be defamatory, libelous or trade libelous, unlawfully
            threatening, or unlawfully harassing; (d) impersonate any person or
            entity or falsely state or otherwise imply an affiliate with a
            person or entity, including any business or educational institution,
            or that is generally false, deceptive, misleading, deceitful,
            misinformative, or constitutes a “bait and switch”; (e) be obscene,
            pornographic, or indecent; (f) violate any community or Internet
            standard; (g) constitute misappropriation of any trade secret or
            know-how; or (h) constitute disclosure of any confidential
          ...
          <p>
            ...
            upon, and sublicense, the User Content, all without any compensation
            to you whatsoever. This license continues even if you stop using our
            Services. If you believe that any content or postings on our
            Services or the Application violate your intellectual property or
            other rights, please follow our Complaint Procedure in Section 12 of
            these Terms.
          </p>
        </li>
        ...
        <li>
          <p />
          <b>Unauthorized Activities.</b> You agree that you will not use our
          Services for: (a) any illegal or unauthorized purposes that violate
          any local, national, or international laws (including but not limited
          to import, export, copyright, trademark and employment
          anti-discrimination laws); (b) contacting any other user of our
          Services who has requested not to be contacted; (c) stalking or
          harassing anyone; (d) data mining, scraping, or for releasing spiders,
          robots, web crawlers, or any other data gathering or extraction tools
          ...
          including any commercial purposes; (j) violating or offending any
          community or Internet standards of decency; or (k) removing,
          circumventing, disabling, damaging or otherwise interfering in any way
          with any security features of our Services aimed at preventing or
          restricting the unauthorized use of our Services or any of the
          Services Materials. You may only use our Services and the Services
          Materials consistently with these Terms. A Business may use our
          Services to create and maintain a culture of workplace diversity and
        ...
        <li>
          ...
          information, products, or services that may be of interest. Our
          Services may also incorporate features and services provided by third
        ...
        <li>
          ...
          made available in connection with our Services, including information
          submitted in connection with the Services Materials or other features
          at any time, with or without notice in its sole discretion.
          <p>
            THE SERVICES MATERIALS, USER CONTENT, SERVICES, PRODUCTS,
            INFORMATION, AND OTHER MATERIALS ON, IN AND MADE AVAILABLE THROUGH
            OUR SERVICES ARE MADE AVAILABLE “AS IS” AND “WITH ALL FAULTS.” USE
            OF OUR SERVICES IS ENTIRELY AT YOUR OWN RISK. UNIVJOBS AND ITS
            LICENSORS MAKE NO REPRESENTATIONS OR WARRANTIES, AND DISCLAIM ALL
            REPRESENTATIONS AND WARRANTIES, WITH RESPECT TO THE USER CONTENT,
            THE SERVICES MATERIALS, SERVICES, PRODUCTS, DATA AND OTHER MATERIALS
            ON, IN AND MADE AVAILABLE THROUGH OUR SERVICES, EXPRESS OR IMPLIED,
            WRITTEN OR ORAL, ARISING FROM COURSE OF DEALING, COURSE OF
            PERFORMANCE, USAGE OF TRADE, OR OTHERWISE, INCLUDING THE IMPLIED
            WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE,
            ACCURACY, SYSTEMS INTEGRATION, NON-INTERFERENCE, QUALITY, TITLE, AND
            NON-INFRINGEMENT. THE ENTIRE RISK AS TO SATISFACTORY QUALITY,
            PERFORMANCE, ACCURACY, COMPLETENESS AND EFFORT WITH REGARD TO ANY
            USER CONTENT, THE SERVICES MATERIALS, SERVICES, PRODUCTS, DATA AND
            OTHER MATERIALS ON, IN AND MADE AVAILABLE THROUGH OUR SERVICES, IS
            WITH YOU.
          </p>
        </li>
        ...
        <li>
          <p />
          <b>LIMITATION OF LIABILITY.</b> UNIVJOBS AND ITS LICENSORS SHALL NOT
          BE LIABLE FOR ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL,
          CONSEQUENTIAL, EXEMPLARY, EXTRA-CONTRACTUAL, OR PUNITIVE DAMAGES OF
          ANY KIND WHATSOEVER, INCLUDING LOST REVENUES OR LOST PROFITS, WHICH
          MAY OR DOES RESULT FROM THE USE OF, ACCESS TO, OR INABILITY TO USE THE
          USER CONTENT, THE SERVICES MATERIALS, SERVICES, PRODUCTS, DATA AND
          OTHER MATERIALS ON, IN AND MADE AVAILABLE THROUGH OUR SERVICES,
          REGARDLESS OF LEGAL THEORY, WHETHER OR NOT YOU OR UNIVJOBS HAD BEEN
          ADVISED OF THE POSSIBILITY OR PROBABILITY OF SUCH DAMAGES, AND EVEN IF
          THE REMEDIES OTHERWISE AVAILABLE FAIL OF THEIR ESSENTIAL PURPOSE.
          UNDER NO CIRCUMSTANCES WILL THE TOTAL LIABILITY OF UNIVJOBS AND ITS
          LICENSORS TO YOU OR ANY OTHER PERSON OR ENTITY IN CONNECTION WITH,
          BASED UPON, OR ARISING FROM THE USER CONTENT, THE SERVICES MATERIALS
          ON, IN AND MADE AVAILABLE THROUGH OUR SERVICES, PRODUCTS, DATA OR
          OTHER MATERIALS OFFERED IN CONNECTION THEREWITH EXCEED THE PRICE PAID
          BY YOU DURING THE PRECEDING YEAR FOR USE OF THE SERVICES AND PRODUCTS.
          SOME STATES DO NOT ALLOW THE LIMITATION OR EXCLUSION OF LIABILITY FOR
          INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE ABOVE LIMITATION OR
          EXCLUSION MAY NOT APPLY TO YOU. IF ANY PART OF THIS LIMITATION ON
        ...
        <li>
          ...
          fraud, violation of law, negligence, willful misconduct, or any other
        ...
        <li>
          ...
          and substance of your complaint, the specific rights at issue, and
          your basis for making the complaint, including the content or posting
          that is objectionable; and (d) the following statement: “The
          statements, representations, and assertions made in this message are
          ...
          <p>
            ...
            email address) to contact@univjobs.ca or by going to your account
            settings and choosing “suspend account.” Please be advised that your
            Services account is not terminated simply by deleting our App from
            your mobile device. Your registration and Services account can only
            be terminated by following the process described above in this
            provision.
          </p>
          <p>
            Upon any termination, all rights and obligations of the parties
            under these Terms shall cease, and you shall immediately stop
            ...
            reasonably be understood to continue in effect shall survive
            (including without limitation, the sections entitled Proprietary
            Rights, No Warranties and Disclaimer, Limitation of Liability,
        ...
        <li>
          ...
          <p>
            ...
            registration and Services account can only be terminated by
          ...
          <p>
            You will only use the App in connection with a device that you own
            or control;
          </p>
          <p>
            You acknowledge and agree that the Channel Partner has no obligation
          ...
          <p>
            ...
            warranty, including those implied by law, you may notify the
            applicable Channel Partner of such failure; upon notification, their
          ...
          <p>
            You represent and warranty that you are not located in a country
            subject to a Canadian Government embargo, or that has been
            designated by the Canadian Government as a “terrorist supporting”
            country, and that you are not listed on any Canadian government list
          ...
          <p>
            ...
            the third party beneficiary hereof; and
          </p>
          <p>
            In the event you use the App to provide you with real-time route
            guidance, YOUR USE OF THIS REAL TIME ROUTE GUIDANCE APPLICATION IS
        ...
        <li>
          <p />
          <b>Relationship Between the Parties.</b> Nothing in these Terms shall
          be construed as making either party the partner, joint venturer,
          agent, legal representative, employer, contractor, or employee of the
          other.
        </li>
        ...
        <li>
          ...
          laws of the province of Ontario, without reference to its conflict of
          law rules; PROVIDED, HOWEVER, THAT THE TERMS OF ANY APPLICABLE LAW NOW
          OR HEREAFTER ENACTED THAT IS BASED ON, DERIVED FROM, SIMILAR TO, OR
          CONNECTED WITH THE UNIFORM COMPUTER INFORMATION TRANSACTIONS ACT
          DRAFTED BY THE NATIONAL CONFERENCE OF COMMISSIONERS ON UNIFORM STATE
          LAWS SHALL NOT APPLY EXCEPT TO THE EXTENT THAT THE LAW EXPRESSLY
          PROHIBITS ALTERATION BY THESE TERMS OF THE APPLICABILITY OF ONE OR
          MORE SECTIONS OF THE LAW. By accessing, viewing, or using the
          services, works, content, or materials on our Services, you consent
          and agree to (a) the exclusive jurisdiction of the federal and state
          courts located in the Ontario, Canada province (b) accept service of
          process by personal delivery or mail; and (c) irrevocably waive the
          right to trial by jury and any jurisdictional and venue defenses
          otherwise available.
          <p>
          ...
          <b>
            ANY ACTION OR PROCEEDING UNDER THESE TERMS WILL TAKE PLACE ONLY ON
            AN INDIVIDUAL BASIS; CLASS ACTIONS AND PROCEEDINGS ARE NOT
            PERMITTED. YOU UNDERSTAND AND AGREE THAT BY ENTERING INTO THESE
            TERMS, YOU AND UNIVJOBS ARE EACH WAIVING THE RIGHT TO TRIAL BY JURY
        ...
        <li>
          ...
          Terms are for reference only and shall not affect the interpretation
          of these Terms. No person or entity not party to this agreement will
          be deemed to be a third party beneficiary of these Terms or any
          provision hereof. When used herein, the words “includes” and
          “including” and their syntactical variations shall be deemed followed
